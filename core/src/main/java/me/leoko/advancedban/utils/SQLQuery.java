...
public enum SQLQuery {
    ...
    SQLQuery(String mysql, String postgres, String hsqldb) {
        this.mysql = mysql;
    ...
    public String toString() {
        switch (DatabaseManager.get().getDatabaseType()){
            case MySQL:
                return mysql;
        ...
        return "INVALID Database: " + DatabaseManager.get().getDatabaseType();
    }
}
